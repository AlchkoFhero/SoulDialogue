...
export function Contact() {
  useEffect(() => {
    AOS.init({
      ...
      mirror: false, // Не повторять анимацию при прокрутке вверх
    });
            ...
            <div className="bg-white rounded-lg shadow-lg p-8" data-aos="fade-right" data-aos-delay="200">
              ...
              <div className="space-y-6">
                ...
                <a
                  ...
                  className="flex items-center justify-center px-3 py-2 w-fit bg-gradient-to-r from-green-400 to-green-600 text-white rounded-full hover:from-green-500 hover:to-green-700 transition-transform transform hover:scale-105 shadow-sm"
                  target="_blank"
                ...
                >
                 ...
                 <a
                    ...
                    className="flex items-center justify-center px-3 py-2 w-fit bg-gradient-to-r from-blue-400 to-blue-600 text-white rounded-full hover:from-blue-500 hover:to-blue-700 transition-transform transform hover:scale-105 shadow-sm"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <MessageCircle className="w-4 h-4 mr-2" />
            ...
            <div className="bg-white rounded-lg shadow-lg p-8" data-aos="fade-left" data-aos-delay="200">
              ...
              <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <button
                      type="submit"
                      className="w-full bg-gradient-to-r from-purple-500 to-purple-700 text-white rounded-md py-2 px-4 hover:from-purple-600 hover:to-purple-800 transition-all shadow-lg"
                      disabled={loading}
                  >
